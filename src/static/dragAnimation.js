...
parcelRequire = (function(modules, cache, entry, globalName) {
    ...
    "Ffm0": [function(require, module, exports) {
        "use strict";

        Object.defineProperty(exports, "__esModule", {
            value: true
        });
        exports.distance = exports.getRandomFloat = exports.clamp = exports.lerp = exports.map = void 0;
    ...
    "jhT6": [function(require, module, exports) {
        var define;
        /*!
         * Unipointer v2.3.0
    ...
    "mCZw": [function(require, module, exports) {
        var define;
        /*!
         * Unidragger v2.3.1
    ...
    "gkRe": [function(require, module, exports) {
        var define;
        /*!
         * Draggabilly v2.2.0
    ...
    }, { "./gsap-core.js": "P74P", "./CSSPlugin.js": "KE4Q" }],
    "yxDH": [function(require, module, exports) {
        "use strict";
        ...
        Draggabilly.prototype.positionDrag = Draggabilly.prototype.setLeftTop; // Image that gets dragged gets this zIndex value which then gets incremented

        var zIndex = 1;

        var DraggableImage = /*#__PURE__*/ function() {
            function DraggableImage(el) {
                var _this = this;

                _classCallCheck(this, DraggableImage);
                ...
                this.DOM.draggable = this.DOM.el.querySelector('.img-drag'); // image element

                this.DOM.innerEl = this.DOM.el.querySelector('.img-drag__inner'); // Image trails

                this.trailsTotal = 20;

                for (var i = 0; i <= this.trailsTotal - 1; ++i) {
                    var _el = document.createElement('img');

                    _el.className = 'img-trail';
                    _el.alt = 'A decorative image';
                    _el.src = this.DOM.innerEl.style.backgroundImage.match(/url\(["']?([^"']*)["']?\)/)[1];
                    this.DOM.el.insertBefore(_el, this.DOM.el.firstChild);
                }

                this.DOM.trails = _toConsumableArray(this.DOM.el.querySelectorAll('.img-trail')); // Dragging position
                ...
                this.threshold = 10;
                this.trailPosition = 0; // Initialize Draggabilly

                this.draggie = new Draggabilly(this.DOM.draggable); // Init/Bind events

                this.initEvents(); // Loop
            ...
            _createClass(DraggableImage, [{
                ...
                value: function initEvents() {
                    ...
                    this.onDragStart = function() {
                        // Reset
                        _this2.draggingPos.previous = {
                            x: 0,
                            y: 0
                        };
                    };

                    this.onDragMove = function(event, pointer, moveVector) {
                        _this2.draggingPos.current = moveVector;
                    };

                    this.onPointerDown = function() {
                        _this2.DOM.el.style.zIndex = zIndex++;
                        _this2.innerScale.current = 1.2;
                        _this2.outerScale.current = 0.8;
                        document.body.style.cursor = 'grabbing';
                        _this2.DOM.draggable.style.cursor = 'grabbing';
                    };

                    this.onPointerUp = function() {
                        // Reset
                        _this2.innerScale.current = 1;
                        _this2.outerScale.current = 1;
                        document.body.style.cursor = 'default';
                        _this2.DOM.draggable.style.cursor = 'grab';
                    };
                ...
                value: function render() {
                    ...
                    this.innerScale.previous = (0, _MathUtils.lerp)(this.innerScale.previous, this.innerScale.current, this.innerScale.amt);
                    this.outerScale.previous = (0, _MathUtils.lerp)(this.outerScale.previous, this.outerScale.current, this.outerScale.amt);
                    this.layout(); // loop
                ...
                value: function layout() {
                    var draggingDistance = (0, _MathUtils.distance)(this.draggingPos.previous.x, this.draggingPos.previous.y, this.draggingPos.current.x, this.draggingPos.current.y); // If the mouse moved more than [this.threshold] then show the next image
                    ...
                    this.DOM.innerEl.style.transform = "scale3d(".concat(this.innerScale.previous, ", ").concat(this.innerScale.previous, ", 1) rotate3d(1,1,1,0.1deg)"); // The draggable element transform

                    this.DOM.draggable.style.transform = "scale3d(".concat(this.outerScale.previous, ", ").concat(this.outerScale.previous, ", 1) rotate3d(1,1,1,0.1deg)");
                }
            }, {
                key: "showNextTrailImage",
                value: function showNextTrailImage() {
                    var _this4 = this;

                    var trailEl = this.DOM.trails[this.trailPosition]; // Kill any tween on the trail

                    _gsap.gsap.killTweensOf(trailEl);

                    _gsap.gsap.timeline({
                            onComplete: function onComplete() {
                                return _this4.resetTrail(trailEl);
                            }
                        }) // show the image
                        .set(trailEl, {
                            startAt: {
                            ...
                            rotation: function rotation() {
                                return (0, _MathUtils.getRandomFloat)(-10, 10);
                            }
                        ...
                        .to(trailEl, 0.3, {
                            ...
                            scale: function scale() {
                                return _this4.outerScale.previous;
                            }
                        }, 0.1);
                }
            }, {
                key: "resetTrail",
                value: function resetTrail(trailEl) {
                    _gsap.gsap.set(trailEl, {
                        opacity: 0,
                        scale: 1,
                        x: this.draggie.position.x,
                        y: this.draggie.position.y,
    ...
    }, { "./../MathUtils": "Ffm0", "draggabilly": "gkRe", "gsap": "f8Z0" }],
    ...
    "GTYq": [function(require, module, exports) {
        "use strict";
        ...
        var preloadImages = function preloadImages() {
            return new Promise(function(resolve, reject) {
                imagesLoaded(document.querySelectorAll('.img-drag__inner, img'), {
                    background: true
                }, resolve);
            });
        }; // Preload fonts
        ...
        Promise.all([preloadImages()]).then(function() {
            _toConsumableArray(document.querySelectorAll('.img-wrap')).forEach(function(element) {
                return new _draggableImage.default(element);
            });

            document.body.classList.remove('loading');
        });
    }, { "./draggableImage": "yxDH", "imagesloaded": "ffUI" }]
}, {}, ["GTYq"], null)